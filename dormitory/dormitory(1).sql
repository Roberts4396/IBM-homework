...
MySQL - 5.5.40 : Database - dormitory
*********************************************************************
*/
...
insert  into `t_b_class`(`id`,`classname`,`teachername`,`createTime`) values 
('402881e44cbbfe2c014cbbfecf730001','11级软件工程2班','李彦宏','2015-04-29 17:56:54'),
('402881e44cbc0292014cbd3aac1f0001','11级计算机科学与技术1班','马化腾','2015-04-15 21:18:01');
...
insert  into `t_b_damage`(`id`,`damagestation`,`damagetime`,`fixtime`,`remark`,`dormid`,`createTime`,`isfixed`) values 
('402881e64cf9f0fe014cf9f189ea0000','888','2015-04-01','2020-01-09','123','402881e54ce9ee7d014ce9f0b6450000','2015-04-27 18:33:30','1');
...
('1','已离校',0,4,'','离校','2015-04-24 16:27:10'),
('402881e54ce9ee7d014ce9f0b6450000','一宿舍',10,9,'高圆圆','这是男生宿舍','2015-04-29 19:49:26'),
('402881e54cea6e2e014cea72c01e0000','二宿舍',10,10,'罗玉凤','这也是男生宿舍','2015-04-24 16:27:10'),
('402881e64d051ccf014d0520f3bf0000','三宿舍',5,4,'古天乐','这是女生宿舍','2015-04-29 20:22:35'),
('402881e64d05267d014d0529d4050002','四宿舍',1,1,'王勇','','2015-04-29 20:32:16');
...
('402881e64d041299014d04135f070000',5,'2015-04-29','402881e54ce9ee7d014ce9f0b6450000','2015-04-29 16:20:25'),
('402881e64d04422d014d0443092c0000',1,'2015-04-29','402881e54cea6e2e014cea72c01e0000','2015-04-29 16:20:11'),
('402881e64d054958014d055417390003',4,'2015-04-22','402881e64d051ccf014d0520f3bf0000','2015-04-29 21:18:26'),
('402881e64d054958014d055459c70004',5,'2015-04-29','402881e64d05267d014d0529d4050002','2015-04-29 21:18:43'),
('402881e64d232d9d014d232e253f0000',5,'2015-05-05','402881e54ce9ee7d014ce9f0b6450000','2015-05-05 16:25:36');
...
('402881e64d05267d014d0527e3f80000','范冰冰','2','2015-04-22','6666','13575798836','402881e44cbbfe2c014cbbfecf730001','402881e64d051ccf014d0520f3bf0000','2015-04-29 20:30:09'),
('402881e64d05267d014d0528d8570001','姚明','1','2015-04-15','8888','13566666666','402881e44cbc0292014cbd3aac1f0001','402881e54ce9ee7d014ce9f0b6450000','2015-04-29 20:31:12');
...
insert  into `t_b_visitor`(`id`,`visitorname`,`studentid`,`relationship`,`starttime`,`endtime`,`remark`,`createTime`) values 
('402881e64d094b2b014d095f25cc0000','李晨','402881e64d05267d014d0527e3f80000','1','2015-04-30 14:08:39','2015-04-30 16:08:44','来了','2015-04-30 16:09:00');
...
insert  into `t_s_depart`(`id`,`departname`,`description`,`parentid`,`createTime`) values 
('1','test','test','1',NULL);
...
insert  into `t_s_resource`(`id`,`createTime`,`description`,`href`,`name`,`order_no`,`resourceType`,`parentid`) values 
('1','2014-08-27 16:05:40','系统','/','系统',1,1,NULL),
('2',NULL,NULL,'userController.do?goUser','用户管理',1,1,'5'),
('3',NULL,NULL,'roleController.do?goRole','角色管理',2,1,'5'),
('4',NULL,NULL,'resourceController.do?goResource','菜单管理',3,1,'5'),
('402881e44cb6a685014cb6a840aa0000','2015-04-14 17:07:19','基本信息管理','/','信息管理',2,1,'1'),
('402881e44cb71ec1014cb723b7f40000','2015-04-15 13:55:55','学生基本信息管理','studentController.do?goStudent','学生管理',1,1,'402881e44cb6a685014cb6a840aa0000'),
('402881e44cbbe87e014cbbea99a80000','2015-04-15 15:10:56','班级信息管理','classController.do?goClass','班级管理',2,1,'402881e44cb6a685014cb6a840aa0000'),
('402881e54ce5b4be014ce5b838fa0000','2015-04-23 17:59:57','管理访客','visitorController.do?goVisitor','访客管理',3,1,'402881e44cb6a685014cb6a840aa0000'),
('402881e54ce5b4be014ce5b8def70001','2015-04-27 10:00:44','管理损坏情况','damageController.do?goDamage','损耗管理',4,1,'402881e44cb6a685014cb6a840aa0000'),
('402881e54ce5b4be014ce5b9a0bb0002','2015-04-23 18:01:30','管理宿舍信息','dormController.do?goDorm','宿舍管理',5,1,'402881e44cb6a685014cb6a840aa0000'),
('402881e64d0404df014d040685870000','2015-04-29 15:14:05','对宿舍进行评分','scoreController.do?goScore','宿舍评分',6,1,'402881e44cb6a685014cb6a840aa0000'),
('5',NULL,NULL,'/','系统管理',9,1,'1');
...
insert  into `t_s_role`(`id`,`createTime`,`description`,`name`) values 
('1','2015-04-29 15:14:30','admin','admin'),
('402881e54c7e34f6014c7e367bfb0000','2015-04-07 20:08:41','','咨询客服');
...
insert  into `t_s_role_resource`(`role_id`,`resource_id`) values 
('402881e54c7e34f6014c7e367bfb0000','2'),
('402881e54c7e34f6014c7e367bfb0000','3'),
('402881e54c7e34f6014c7e367bfb0000','1'),
('402881e54c7e34f6014c7e367bfb0000','5'),
('1','1'),
('1','402881e44cb6a685014cb6a840aa0000'),
('1','402881e44cb71ec1014cb723b7f40000'),
('1','402881e44cbbe87e014cbbea99a80000'),
('1','402881e54ce5b4be014ce5b838fa0000'),
('1','402881e54ce5b4be014ce5b8def70001'),
('1','402881e54ce5b4be014ce5b9a0bb0002'),
('1','402881e64d0404df014d040685870000'),
('1','5'),
('1','2'),
('1','3'),
('1','4');
...
insert  into `t_s_user`(`id`,`createTime`,`email`,`password`,`phone`,`position`,`position_desc`,`real_name`,`status`,`userName`,`departid`) values 
('1','2015-04-03 14:32:12','ser@qq.com','202cb962ac59075b964b07152d234b70','','','','小红',1,'admin',NULL),
('402881e54c7e3e72014c7e3f6dbc0000','2015-04-03 15:47:08','','202cb962ac59075b964b07152d234b70','','','','',1,'test',NULL);
...
('402881e54c7e3e72014c7e3f6dbc0000','402881e54c7e34f6014c7e367bfb0000'),
('1','1');
